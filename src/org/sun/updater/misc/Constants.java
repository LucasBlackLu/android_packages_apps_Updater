...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/LucasBlackLu/OTA/%s/%s/ota.json";
    static final String CHANGELOG_URL = "https://raw.githubusercontent.com/LucasBlackLu/OTA/%s/%s/changelog_%s.txt";
    static final String CHANGELOG_URL_LOCALE = "https://raw.githubusercontent.com/LucasBlackLu/OTA/%s/%s/changelog_%s-%s-r%s.txt";
